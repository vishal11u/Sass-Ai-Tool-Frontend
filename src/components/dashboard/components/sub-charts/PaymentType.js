...
function PaymentType() {
    ...
    const fetchContactData = async (filter) => {
        ...
        try {
            const response = await axios.get(`http://localhost:5000/dashboard/contacts/${activeButton}`);
            const contactEntries = response.data; // Assuming you get an array of contacts
